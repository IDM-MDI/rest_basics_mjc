...
public class EntityQuery {
    ...
    public static final String UPDATE_GIFT = "UPDATE gift_certificate " +
    ...
    public static final String FIND_BY_ID_GIFT = "SELECT * FROM gift_certificate WHERE id = ?";
    ...
    public static final String UPDATE_MTM_BY_GIFT_ID = "UPDATE gift_tag SET ";
}
